...
const login: TranslationStrings = {
  ...
  'login.createAdminHint': 'Set up the first admin account for Savanna Escape.',
  ...
  'login.insecureCookie.body':
    'You’re connecting over plain HTTP, so your browser drops Savanna Escape’s secure session cookie — the next request fails with "Access token required". Fix: use HTTPS, or for a home-lab set COOKIE_SECURE=false.',
