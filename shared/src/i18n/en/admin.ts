...
const admin: TranslationStrings = {
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'savanna-admin-alerts',
  ...
  'admin.plugins.disabledBody':
    'The plugin runtime is turned off (SAVANNA_PLUGINS_ENABLED). No plugin can run until an admin enables it in the server configuration.',
  ...
  'admin.plugins.requiresTrek': 'Requires Savanna Escape {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Reviewed" means a Savanna Escape maintainer scanned this plugin for malware on each version — not for quality or whether it works. It is not a guarantee that a plugin is harmless.',
  ...
  'admin.plugins.security.reviewedBody':
    'A reviewed plugin was manually scanned for malware by a Savanna Escape maintainer on each version — checked for hostile code, not for whether it works well. It is not a promise that the plugin is harmless.',
  'admin.plugins.security.trustTitle': 'The bottom line',
  'admin.plugins.security.trustBody':
    'Installing a plugin is like installing any third-party app: only add code from authors you trust, and when in doubt, inspect it yourself first. Savanna Escape takes no responsibility for third-party plugins.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Savanna Escape experience.',
  ...
  'admin.weather.description':
    'Savanna Escape uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Savanna Escape',
  'admin.update.available': 'Update available',
  'admin.update.text': 'Savanna Escape {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'Savanna Escape will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your Savanna Escape instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This Savanna Escape instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',
  ...
  'admin.passkey.rpIdHint':
    'The bare domain passkeys are bound to, e.g. savanna.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Comma-separated full origins, e.g. https://savanna.example.org. Leave empty to use APP_URL.',
