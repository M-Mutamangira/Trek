...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan Savanna Escape's future. Their monthly contribution goes straight into development and real hours spent — so Savanna Escape stays Open Source.",
  ...
  'settings.about.description':
    'Savanna Escape is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
