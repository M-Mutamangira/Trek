...
const settings: TranslationStrings = {
  ...
  'settings.map3dHint': 'Pitch + real 3D building extrusions â€” works on every style, including satellite.',
  ...
  'settings.notificationPreferences.notConfigured': 'Not configured yet â€” set it up in the pluginâ€™s settings',
  ...
  'settings.notificationPreferences.pluginConfigured': 'Configured. Manage credentials on the pluginâ€™s settings page.',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-savanna-alerts',
  ...
  'settings.mcp.modal.creating': 'Creatingâ€¦',
  'settings.mcp.modal.create': 'Create Token',
  'settings.mcp.modal.createdTitle': 'Token Created',
  'settings.mcp.modal.createdWarning':
    'This token will only be shown once. Copy and store it now â€” it cannot be recovered.',
  ...
  'settings.oauth.rotateSecretConfirming': 'Rotatingâ€¦',
  'settings.oauth.rotateSecretDoneTitle': 'New Secret Generated',
  'settings.oauth.rotateSecretDoneWarning':
    'This secret is shown only once. Copy it now and update your application â€” all previous sessions have been invalidated.',
  ...
  'settings.oauth.modal.scopesHint':
    'list_trips and get_trip_summary are always available â€” no scope required. They let the AI discover trip IDs needed to use any other tool.',
  'settings.oauth.modal.selectAll': 'Select all',
  'settings.oauth.modal.deselectAll': 'Deselect all',
  'settings.oauth.modal.creating': 'Registeringâ€¦',
  'settings.oauth.modal.create': 'Register Client',
  'settings.oauth.modal.createdTitle': 'Client Registered',
  'settings.oauth.modal.createdWarning': 'The client secret is shown only once. Copy it now â€” it cannot be recovered.',
  ...
  'settings.oauth.modal.machineClientHint':
    'Use client_credentials grant â€” no redirect URIs needed. The token is issued directly via client_id + client_secret and acts as you within the selected scopes.',
  ...
  'settings.about.supporters.title': 'Travel companions for Savanna Escape',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan Savanna Escape's future. Their monthly contribution goes straight into development and real hours spent â€” so Savanna Escape stays Open Source.",
  ...
  'settings.passkey.description':
    'Sign in faster and phishing-resistant with a passkey â€” your fingerprint, face, PIN, or a hardware key. Your password stays as a backup.',
  ...
  'settings.airtrail.hint':
    'Connect your self-hosted AirTrail to import and sync flights. Create an API key in AirTrail under Settings â†’ Security.',
  'settings.airtrail.url': 'Instance URL',
  'settings.airtrail.apiKey': 'API key',
  'settings.airtrail.apiKeyPlaceholder': 'Bearer API key',
  'settings.airtrail.apiKeyHint': 'Generated in AirTrail under Settings â†’ Security. Stored encrypted.',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and Savanna Escape only reads from it. Turn on to push edits made in Savanna Escape back to AirTrail.',
  ...
  'settings.airtrail.test.success': 'Connected â€” {count} flight(s) found',
  ...
  'settings.aiParsing.baseUrlHint': 'Where the model runs â€” a local Ollama server or an OpenAI-compatible endpoint.',
  ...
  'settings.aiParsing.multimodalHint': 'For vision-capable models â€” sends the original PDF instead of extracted text.',
  ...
  'settings.offline.mode.active': 'Offline mode is on â€” your changes are queued and will sync when you turn it off.',
  'settings.offline.prepare.title': 'Prepare for offline',
  'settings.offline.prepare.hint':
    'Download everything you need â€” trip data, documents and map tiles â€” before you lose connection.',
  'settings.offline.prepare.button': 'Download for offline use',
  'settings.offline.prepare.running': 'Downloadingâ€¦',
  ...
  'settings.offline.resyncing': 'Syncingâ€¦',
  ...
  'settings.offline.loading': 'Loadingâ€¦',
  ...
  'settings.offline.conflicts.item': 'Change to â€œ{name}â€',
  ...
  'settings.offline.banner.queued': 'Offline Â· {count} queued',
  'settings.offline.banner.syncing': 'Syncing {count}â€¦',
