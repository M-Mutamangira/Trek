...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'The MCP integration has been fully overhauled. OAuth 2.1 is now the recommended auth method. Legacy static tokens (savanna_…) are deprecated and will be removed in a future release.',
  ...
  'system_notice.welcome_v1.title': 'Welcome to Savanna Escape',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with Savanna Escape planning UI overlay',
