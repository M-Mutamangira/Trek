...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your Savanna Escape account. Please sign in first.',
  'oauth.authorize.loginButton': 'Sign in to Savanna Escape',
  'oauth.authorize.requestLabel': 'Authorization Request',
  'oauth.authorize.requestDescription': 'This application is requesting access to your Savanna Escape account.',
