...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur Savanna Escape Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the Savanna Escape Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de Savanna Escape',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من Savanna Escape',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo Savanna Escape',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 'calc(17px * var(--fs-scale-subtitle, 1))', fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="Savanna Escape" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>
